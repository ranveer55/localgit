...
class CompanyCohortsPlacementMistakeDetailReport extends Component {
  ...
  loadReport(selectedDate) {
    ...
    global.api.getUserPlacementMistakesDetailByCohort(
        ...
        <section className="section_box">
          <div className="row">
            <div className="col-md-12">
              <h1 className="title1 mb25">Cohorts Placement Mistakes</h1>
...
export default CompanyCohortsPlacementMistakeDetailReport;
